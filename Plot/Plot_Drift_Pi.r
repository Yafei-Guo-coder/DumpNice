library(tidyverse)
library(reshape2)
setwd("/Users/guoyafei/Documents/个人项目/Project-2-Migration/基本统计/Plots/Drift")
...
pi <- read.table("/Users/guoyafei/Documents/个人项目/Project-2-Migration/基本统计/Plots/PI/Pi_stat.txt",header=T,stringsAsFactors = F,sep="\t")
data$pi <- pi$value
data$sd <- pi$sd
